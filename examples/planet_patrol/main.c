/*
 * PLANET PATROL for Amiga
 *
 * Classic Planet Patrol arcade clone with:
...
int main(int argc, char *argv[])
{
    ...
    /* Bridge */
    ab_init("planet_patrol");
    AB_I("Planet Patrol starting");
    ...
    /* Sound */
    sound_init();
    if (sound_load_mod("DH2:Dev/planet_patrol.mod")) {
        AB_I("MOD loaded");
        sound_start_music();
    } else {
